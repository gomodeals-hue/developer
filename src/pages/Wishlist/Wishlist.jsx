...
import { Heart, Share2, Copy, Check, ShoppingBag } from 'lucide-react';
...
const Wishlist = () => {
  const { wishlist, moveToCart, t } = useShop();
            ...
            {wishlist.map((product) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full mt-3 py-3 bg-orange-955 text-white text-[9px] uppercase tracking-[0.25em] font-black flex items-center justify-center gap-2 hover:bg-orange-850 transition-colors cursor-pointer shadow-sm rounded-none"
                >
                  <ShoppingBag size={13} /> {t ? t("Move to Cart") : "Move to Cart"}
                </button>
              </motion.div>
            ))}
          </AnimatePresence>
