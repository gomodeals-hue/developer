...
import { X, Trash2, Plus, Minus, ShoppingBag, ArrowRight, ShieldCheck, Crown, Star } from 'lucide-react';
                ...
                {membership !== 'free' ? (
                  <div className={`mt-3 rounded-xl px-3 py-2.5 flex items-center gap-2 ${
                    ...
                    <span className="flex-shrink-0">
                      {membership === 'platinum' ? <ShieldCheck size={16} className="text-indigo-300" /> : membership === 'gold' ? <Crown size={16} className="text-amber-300" /> : <Star size={16} className="text-slate-300" />}
                    </span>
                  ...
                  <div className="mt-3 rounded-xl px-3 py-2.5 bg-orange-50/60 border border-orange-100/60 flex items-center gap-2 cursor-pointer hover:bg-orange-100/60 transition-colors" onClick={() => { setCartDrawerOpen(false); navigate('/membership'); }}>
                    <Crown size={15} className="text-orange-600 flex-shrink-0" />
