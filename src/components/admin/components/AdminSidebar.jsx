...
import {
  ...
  Ticket, Shield, BarChart3,
  MessageSquare, ShieldCheck, RotateCcw,
  Image, Trophy, Layers, Home, Boxes, FileSpreadsheet
} from "lucide-react";
...
const navItems = [
  ...
  { title: "Reports", path: "/admin/reports", icon: FileSpreadsheet },
