...
import { Trophy, Plus, Users, Award, Calendar, DollarSign, CheckCircle2, ChevronDown, ChevronUp, Star, ThumbsUp, ArrowUpDown, Edit, Trash2, AlertTriangle, ShieldCheck } from 'lucide-react';
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="bg-amber-50/80 border border-amber-200/80 rounded-2xl p-3.5 text-left mb-6 text-xs text-amber-950 flex items-start gap-3 shadow-xs">
                <DollarSign className="text-amber-600 mt-0.5 flex-shrink-0" size={16} />
