...
import { Laptop, Shirt, Home, Sun, Flower2, ShoppingBag } from 'lucide-react';
...
const categories = [
  ...
  },
  {
    id: 'pooja-items',
    title: 'Pooja Items',
    icon: <Sun className="w-8 h-8 stroke-[1.25px]" />,
    filter: 'pooja-items'
  },
  {
    id: 'beauty',
  ...
  },
  {
    ...
    icon: <ShoppingBag className="w-8 h-8 stroke-[1.25px]" />,
    filter: 'grocery'
  }
];
