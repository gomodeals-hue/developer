            ...
            >
              ...
              <div className="relative overflow-hidden rounded-t-[2rem] bg-gradient-to-br from-orange-500 via-amber-500 to-orange-600 px-6 py-6 text-center">
                ...
                <motion.div
                  ...
                  className="w-12 h-12 rounded-xl bg-white/20 border border-white/30 flex items-center justify-center text-white mx-auto mb-2 shadow-lg backdrop-blur-sm"
                >
                ...
                >
                  {[
                    ...
                    { icon: <ShieldCheck size={8} />, text: 'Exclusive Deals' },
                  ].map((p, i) => (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {WELCOME_TIERS.map((tier, idx) => (
                    ...
                    >
                      ...
                      <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${tier.headerGrad} flex items-center justify-center text-white mb-2 shadow`}>
                        <tier.icon size={16} />
                      </div>
